...
import { Search, ShoppingBag, User, Menu, X, LogOut, Settings, Package, Facebook, Instagram } from 'lucide-react';
...
export function Header() {
  ...
  return (
    <>
      {/* Top Bar with Follow Us */}
      <div className="bg-almans-chocolate text-almans-cream">
        <div className="container flex h-8 items-center justify-end gap-4 px-4 md:px-8">
          ...
          <div className="flex items-center gap-2">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex h-5 w-5 items-center justify-center text-almans-cream/80 transition-colors hover:text-almans-cream"
